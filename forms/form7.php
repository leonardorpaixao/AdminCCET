<?php
    ...
    if(($_SESSION['nivel'] == '1' || $_SESSION['id'] == $idUser) && ($tipoReq == 7)){
...
<body style="font-family: Segoe UI,Frutiger,Frutiger Linotype,Dejavu Sans,Helvetica Neue,Arial,sans-serif;">
    <div class="dentro" style="font-size: 12px;">
		<h2 style="text-align: center;">REQUERIMENTO GERAL</h2>
		...
		<br>
		<div class="titulo">SOLICITAÇÃO</div>
		<div class="normal" style="text-align: justify;text-indent: 1.5em;">'.$conteudoReq.'</div>
		<br>
