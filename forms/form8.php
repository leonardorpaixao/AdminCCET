<?php
    ...
    if(($_SESSION['nivel'] == '1' || $_SESSION['id'] == $conteudo[2] || $_SESSION['id'] == $idUser) && ($tipoReq == 8)){
...
<body style="font-family: Segoe UI,Frutiger,Frutiger Linotype,Dejavu Sans,Helvetica Neue,Arial,sans-serif;">
    <div class="dentro" style="font-size: 12px;">
		<h2 style="text-align: center;">REQUERIMENTO DE ENSINO INDIVIDUAL</h2>
		...
		<br>
		<p style="text-align: justify;text-indent: 1.5em;">Venho, por meio deste, requerer matrícula de <b>ENSINO INDIVIDUAL</b> na disciplina <b>'.$conteudo[2].'</b>, código <b>'.$conteudo[1].'</b>, período letivo <b>'.$conteudo[0].'</b>.</p>
		<br>
		<div class="titulo">INFORMAÇÕES DO REQUERIMENTO</div>
		<div class="normal"><b>Status:</b> '.$status.'</div>
		<div class="normal"><b>Docente desejado (Opcional):</b> '.$conteudo[3].'</div>
		<div class="normal"><b>Observação do aluno (Opcional):</b> '.$conteudo[4].'</div>
		<div class="normal"><b>Coordenador responsável:</b> '.$professor.'</div>
