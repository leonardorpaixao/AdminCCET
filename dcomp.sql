...
--
-- Host: 127.0.0.1
-- Generation Time: 07-Mar-2018 às 03:27
...
--
ALTER TABLE `tbafiliacao`
  MODIFY `idAfiliacao` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tbblock`
  MODIFY `idBlock` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbbugs`
--
ALTER TABLE `tbbugs`
  MODIFY `idBug` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `tbcontatemp`
--
ALTER TABLE `tbcontatemp`
  MODIFY `idConta` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `tbcor`
--
ALTER TABLE `tbcor`
  MODIFY `idCor` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tbdata`
--
ALTER TABLE `tbdata`
  MODIFY `idData` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26870;
...
--
ALTER TABLE `tbequipamento`
  MODIFY `patrimonio` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=239323;

--
-- AUTO_INCREMENT for table `tbinclusao`
--
ALTER TABLE `tbinclusao`
  MODIFY `idInc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=286;

--
-- AUTO_INCREMENT for table `tblaboratorio`
--
ALTER TABLE `tblaboratorio`
  MODIFY `idLab` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `tblogsacesso`
  MODIFY `idLogs` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29171;

--
-- AUTO_INCREMENT for table `tblogsacoes`
--
ALTER TABLE `tblogsacoes`
  MODIFY `idLogs` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17294;

--
-- AUTO_INCREMENT for table `tblogsforcado`
--
ALTER TABLE `tblogsforcado`
  MODIFY `idLogs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2366;

--
-- AUTO_INCREMENT for table `tbnotificacao`
--
ALTER TABLE `tbnotificacao`
  MODIFY `idNoti` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=458;

--
-- AUTO_INCREMENT for table `tbprazo`
--
ALTER TABLE `tbprazo`
  MODIFY `idPrazo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tbreqs_professor`
--
ALTER TABLE `tbreqs_professor`
  MODIFY `idReqs_professor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=415;

--
-- AUTO_INCREMENT for table `tbrequerimentos`
--
ALTER TABLE `tbrequerimentos`
  MODIFY `idReq` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1377;

--
-- AUTO_INCREMENT for table `tbreservaeq`
--
ALTER TABLE `tbreservaeq`
  MODIFY `idReEq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=304;

--
-- AUTO_INCREMENT for table `tbreservalab`
--
ALTER TABLE `tbreservalab`
  MODIFY `idReLab` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1061;

--
-- AUTO_INCREMENT for table `tbreservasala`
--
ALTER TABLE `tbreservasala`
  MODIFY `idReSala` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=857;

--
-- AUTO_INCREMENT for table `tbsala`
--
ALTER TABLE `tbsala`
  MODIFY `idSala` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tbtelefone`
--
ALTER TABLE `tbtelefone`
  MODIFY `idTelefone` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21784;

--
-- AUTO_INCREMENT for table `tbtemporarios`
--
ALTER TABLE `tbtemporarios`
  MODIFY `idTemp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=167;
...
--
ALTER TABLE `tbticket`
  MODIFY `idTicket` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1055;

--
-- AUTO_INCREMENT for table `tbtipoeq`
--
ALTER TABLE `tbtipoeq`
  MODIFY `idTipoEq` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tbusuario`
--
ALTER TABLE `tbusuario`
  MODIFY `idUser` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14056;

--
-- AUTO_INCREMENT for table `tbusuariosexternos`
--
ALTER TABLE `tbusuariosexternos`
  MODIFY `idExterno` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14147;
