<?php
  include 'topo.php';
?>
<title>AdminDcomp - Alunos Temporários</title>
</head>
<?php
  ...
  if($query = $db->prepare("SELECT a.idUser, a.nomeUser, a.login, AES_DECRYPT(a.email, ?), a.statusUser, b.afiliacao FROM tbusuario a inner join tbafiliacao b on a.idAfiliacao = b.idAfiliacao WHERE a.nivel = 5 ORDER BY a.nomeUser")){
            ...
            <div class="box-header">
              <?php
                if($_SESSION['logado'] && $_SESSION['nivel'] == 0)
                  echo '<a href="/recursos/alunos-temporarios/adicionar"><button class="btn btn-success">Adicionar</button></a>';
              ?>
            </div>
