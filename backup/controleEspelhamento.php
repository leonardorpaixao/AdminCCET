...
function listar_pacotes(){
	...
	$file = fopen("./log/lista.txt", "r+") or die("Unable to open file!"); //abrindo arquivo da lista
...
function add_pacote($nome_pacote){
	...
	$file = fopen("./log/lista.txt", "a") or die("Unable to open file!"); //abrindo arquivo
