                      ...
                      while($query->fetch()){
                        ...
                        switch ($tipoReq) {
                          ...
                          case 3:
                            ...
                            break;
                          case 4:
                            $tipo = 'Requerimento de Estágio Supervisionado<br>'.$conteudo[1].' - '.$conteudo[0].' - '.$conteudo[2];
                            break;
                          case 6:
                            $tipo = 'Requerimento de Trabalho de Conclusão de Curso<br>'.$conteudo[2].' - '.$conteudo[1].' - '.$conteudo[3];
                            break;
                          case 7:
