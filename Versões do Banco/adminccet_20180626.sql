...
--
-- Host: 127.0.0.1
-- Generation Time: 26-Jun-2018 às 08:25
...
--
-- Extraindo dados da tabela `tbchoquesala`
--

INSERT INTO `tbchoquesala` (`idReSala`, `idData`, `idChoqueReSala`, `idChoqueData`) VALUES
(5, 26878, 2, 26874);
...
(2, '2018-06-26 04:52:26', 'd40lq56f911qsegpvemla0ssgm', NULL, NULL);
...
(2, 4, 1, '', 'DEPART', '2018-12-22'),
(3, 1, 1, 'tcc', 'TCC - tcc123', '2018-12-23'),
(4, 2, 1, 'Apresentação de Soluções Químicas', 'TCC - Daniel Oliveira', '2018-12-23'),
(5, 2, 1, 'teste', 'Doutorado - Cyborg', '2018-12-23'),
(6, 2, 1, 'tesrfrerw', 'Doutorado - Cyborg', '2018-12-23');
...
(1, '', 1, 'professor', '123', 'leonardorpaixao3@gmail.com', '', 'Professor', '1123', '0000-00-00', '', 3, 'Ativo', 1, 1, 'Ativo'),
(2, '', 2, 'secretaria', '123', 'leonardorpaixao3@gmail.com', '', 'Secretaria', '', '0000-00-00', '', 1, 'Ativo', 1, 1, 'Ativo'),
(3, '', 3, 'aluno', '123', 'abc123@xyz.com', '', 'Aluno', '', '0000-00-00', '', 4, 'Ativo', 1, 0, 'Ativo'),
(4, '', 4, 'admin', 'admin', 'abc@abc.com', '', 'Adminstrador', '123', '0000-00-00', '', 0, 'Ativo', 1, 1, 'Ativo'),
(5, '201210011300', 3, 'leonardorpaixao3@gmail.com', 'ccet123456', 'leonardorpaixao3@gmail.com', '', 'Leonardo Rodrigues Paixão', '12345678954', '0000-00-00', '', 4, 'Ativo', 1, 1, 'Ativo'),
(12, NULL, 1, 'teste', 'teste', NULL, '', 'Teste', NULL, '1994-07-28', '', 3, 'Ativo', 1, 1, 'Ativo'),
(13, '201210011300', 1, 'teste2', '123456', 'leonardorpaixao3@gmail.com', '', 'LEONARDO TESTE', '02531214564', '1989-06-15', '78979878978', 3, 'Ativo', 1, 1, 'Ativo'),
(14, '231321321', 2, 'teste3', '123456', 'leonardorpaixao3@gmail.com', 'DCCOMP', 'teste3', '02514092523', '1994-07-28', '79998019211', 1, 'Inativo', 1, 1, 'Ativo');
...
--
ALTER TABLE `tbdata`
  MODIFY `idData` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26880;
...
--
ALTER TABLE `tblogsacoes`
  MODIFY `idLogs` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17489;
...
--
ALTER TABLE `tbnotificacao`
  MODIFY `idNoti` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tbreservaeq`
  MODIFY `idReEq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbreservasala`
  MODIFY `idReSala` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
