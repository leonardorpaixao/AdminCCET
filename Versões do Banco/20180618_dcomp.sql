...
--
-- Host: 127.0.0.1
-- Generation Time: 19-Jun-2018 às 13:06
...
(1, 1, 'professor', '1123', '123', 'Professor', 3, 'Aguardando Solicitante', 'tharlyssonbreno@gmail.com', 1, 1, 'Ativo', ''),
...
--
ALTER TABLE `tblogsacoes`
  MODIFY `idLogs` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17345;
