...
?>
<title>AdminDcomp - Ensino Individual</title>
</head>
<?php
  include '../../includes/barra.php';
  include '../../includes/menu.php';
  $_SESSION['irPara'] = '/requerimentos/inserir/8/';
  $link = '/requerimentos/inserir/8/';
...
?>
      ...
      <div class="content-wrapper">
          ...
          <div class="box" id="forminsere">
            <div class="box-header with-border">
                ...
                <form role="form" action="post/" method="post" class="formulario">
                  ...
                  <input type="hidden" id="tipoReq" name="tipoReq" value="8"><!-- Número correspodente ao tipo -->
                  <div class="box-body">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                    ...
                    <div class="form-group">
                      <label>Código da Disciplina (verifique no SIGAA):</label>
                      <input type="text" class="form-control" name="codigo" id="codigo" required>
                    </div>
                    <div class="form-group">
                      <label>Nome da Disciplina:</label>
                      <input type="text" class="form-control" name="disciplina" id="disciplina" required>
                    </div>
                    <div class="form-group">
                      <label>Professor (opcional - não garante que será o docente selecionado):</label>
        ...
        <?php
          ...
          elseif($acao == 'edit' && (!is_null($id))){
              ...
              if(($_SESSION['nivel'] == '1' || $_SESSION['id'] == $idUser) && ($statusReq == 'PendenteProf' || $statusReq == 'Pendente' || $statusReq == 'NegadoProf') && ($tipoReq == 8)){
        ?>
        <?php
          if(isset($_SESSION['avisoReqs'])):
        ?>
          ...
          <div class="box" id="formedita">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                    ...
                    <div class="form-group">
                      <label>Código da Disciplina (verifique no SIGAA):</label>
                      <input type="text" class="form-control" name="codigo" id="codigo" value="<?php echo $conteudo[1]; ?>">
                    </div>
                    <div class="form-group">
                      <label>Nome da Disciplina:</label>
                      <input type="text" class="form-control" name="disciplina" id="disciplina" value="<?php echo $conteudo[2]; ?>">
                    </div>
                    <div class="form-group">
                      <label>Professor (opcional - não garante que será o docente selecionado):</label>
                      <input type="text" class="form-control" name="prof" id="prof" value="<?php echo $conteudo[3]; ?>">
                    </div>
                    <div class="form-group">
                      <label>Observação (opcional):</label>
                    ...
                    <div class="form-group">
                      ...
                      <option value="0" <?php if($conteudo[5] == 0) echo 'selected'; ?>>Outro professor (Não aparece na lista)</option>
                      <?php
                        $db = Atalhos::getBanco();
                        ...
                        while($query->fetch()){
                      ?>
                        <option value="<?php echo $idUser;?>" <?php if($conteudo[5] == $idUser) echo 'selected'; ?>><?php echo $nomeUser;?></option>
                      <?php
                            }        
                        $query->close();
                      ?>
    ...
    $('#forminsere').find('.formulario').submit(function() {
        ...
        if(!(codigo.length != 0 && disciplina.length != 0 && periodo != "")) {
