                  ...
                  <thead>
                    ...
                    <?php
                      while($query->fetch()){
                        ...
                        if($tipoReq == 4 && $statusReq == 'Aprovado')
                          echo '<a target="_blank" href="https://www.sigaa.ufs.br/sigaa/verProducao?idProducao=678216&key=0dea497be2fdb3fbda8e68db25dcd7bc" 
                           class="btn btn-primary btn-xs" data-toggle="tooltip" title="Relatório final de Estágio Supervisionado" style="margin-left: 2px;"><i class="fa fa-download"></i></a>';
                        echo '</td>
                                <td>'.$acao.'</td>
                              </tr>';
                      }
