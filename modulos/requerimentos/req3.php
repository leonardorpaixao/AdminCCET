...
?>
      ...
      <div class="content-wrapper">
        ...
        <?php
          ...
          elseif($acao == 'edit' && (!is_null($id))){
              ...
              if(($_SESSION['nivel'] == '1' || $_SESSION['id'] == $idUser) && ($statusReq == 'PendenteProf') && ($tipoReq == 3)){
        ?>
        <?php
          if(isset($_SESSION['avisoReqs'])):
        ?>
    ...
    <script>
      ...
      $('#forminsere2').find('.formulario').submit(function() {
        ...
        if(!(professor != "" && turma != "" && disciplina != "" && datacomeco.length != 0 && datafim.length != 0 && (veriMat == 1 || (veriMat == 2 && nome.length != 0 && curso.length != 0 && telefone.length != 0 && email.length != 0 && email2.length != 0 && email == email2)))) {
