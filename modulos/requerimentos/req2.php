          ...
          <div class="box" id="forminsere">
            ...
            <form role="form" action="post/" method="post" class="formulario">
              ...
              <div class="box1">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="inst-logradouro" id="inst-logradouro">
                  </div>
                  <div class="form-group">
                    <label>Número</label>
                    <input type="number" class="form-control" name="inst-numero" id="inst-numero">
                  </div>
                  <div class="form-group">
                    <label>Bairro</label>
                    <input type="text" class="form-control" name="inst-bairro" id="inst-bairro">
                  </div>
                  <div class="form-group">
                    <label>Complemento</label>
                    <input type="text" class="form-control" name="inst-complemento" id="inst-complemento">
                  </div>
                  <div class="form-group">
                    <label>Cidade/UF</label>
                    <input type="text" class="form-control" name="inst-cidadeuf" id="inst-cidadeuf">
                  </div>
                  <div class="form-group">
                    <label>E-mail Institucional</label>
                    <input type="text" class="form-control" name="inst-email" id="inst-email">
                  </div>
                  <div class="form-group">
              ...
              <div class="box5">
                ...
                <div class="box-body">
                  <textarea maxlenght="3700" name="plano" id="plano" class="form-control" rows="15" cols="auto"></textarea>
                </div>
              </div><!-- /.box -->
          ...
          <div class="box" id="formedita">
            <div class="box-header with-border">
                ...
                <form role="form" action="post/" method="post" class="formulario">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label>Logradouro</label>
                      <input type="text" class="form-control" name="inst-logradouro" id="inst-logradouro" value="<?php echo $i[4];?>" required>
                    </div>
                    <div class="form-group">
                      <label>Número</label>
                      <input type="number" class="form-control" name="inst-numero" id="inst-numero" value="<?php echo $i[5];?>" required>
                    </div>
                    <div class="form-group">
                      <label>Bairro</label>
                      <input type="text" class="form-control" name="inst-bairro" id="inst-bairro" value="<?php echo $i[6];?>" required>
                    </div>
                    <div class="form-group">
                      <label>Complemento</label>
                      <input type="text" class="form-control" name="inst-complemento" id="inst-complemento" value="<?php echo $i[7];?>" required>
                    </div>
                    <div class="form-group">
                      <label>Cidade/UF</label>
                      <input type="text" class="form-control" name="inst-cidadeuf" id="inst-cidadeuf" value="<?php echo $i[8];?>" required>
                    </div>
                    <div class="form-group">
                      <label>E-mail Institucional</label>
                      <input type="text" class="form-control" name="inst-email" id="inst-email" value="<?php echo $i[9];?>" required>
                    </div>
                    <div class="form-group">
                      <label>Telefone fixo</label>
            ...
            <div class="box">
                <div class="box-header with-border">
                  ...
                  <div class="box-body">
                    <textarea maxlenght="3700" name="plano" id="plano" class="form-control" rows="15" cols="auto" required><?php echo $conteudo[4];?></textarea>
                    </div>
                  </div><!-- /.box -->
