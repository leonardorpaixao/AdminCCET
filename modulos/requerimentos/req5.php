              ...
              <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <p><?php echo $prazo[3];?></p>
                      <input type="hidden" class="form-control" name="periodo" id="periodo" value="<?php echo $prazo[3];?>">
                    </div>
                    <div class="form-group">
        ...
        <div class="callout callout-info">
          ...
          <div class="box" id="forminsere">
            <div class="box-header with-border">
                ...
                <form role="form" action="post/" method="post" class="formulario" autocomplete="off">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <label>Período letivo</label>
                      <p><?php echo $conteudo[0];?></p>
                      <input type="hidden" class="form-control" name="periodo" id="periodo" value="<?php echo $conteudo[0];?>">
                    </div>
                    <div class="form-group">
                      <label>Situação</label>
                      <select class="form-control" name="situacao" id="situacao">
                    ...
                    <div class="form-group">
                      <label>Anexar histórico (acesse seu SIGAA, baixe o seu histórico e anexe o PDF aqui):</label>
                      <p><a href="getPdf/<?php echo $id;?>/">Visualizar</a></p>
                    </div> 
                  </div>
                  <div class="box-footer">
