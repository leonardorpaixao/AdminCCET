          ...
          <div class="col-md-3">
            ...
            <div class="box box-primary">
              <div class="box-body box-profile">
                <center>
                  <div class="img-circle center-block" style="background-image: url('getimagem/0/'); background-size: 100% 100%;height: 160px;width: 160px;"></div>
                </center>
                <?php
                  if($_SESSION['logado']){
                    if($_SESSION['nivel'] == 0){
                      ...
                      if($statusUser == 'Ativo'){
                        echo '<a class="btn btn-default btn-block" data-toggle="modal" data-target="#simples" data-solict-id="'.$idConta.'" data-solict-tipo="1" data-solict-frase="Inativar Conta '.$login.'">
                                  <i class="fa fa-user-times"> </i> Inativar Usuário
                                </a>';
                      ...
                      if($sudo == 'Ativo'){
                        ...
                        data-solict-tipo="2" data-solict-frase="Retirar sudo do Usuário">
                        <i class="fa fa-linux"></i> Desativar Sudo
                        </a>';
                      }else{
                        echo '<a class="btn btn-default btn-block" data-toggle="modal" data-target="#simples" data-solict-id="'.$idUser.'"
                        data-solict-tipo="3" data-solict-frase="Dar sudo ao Usuário">
