                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <?php
                                        echo "<img height='25' width='25' class='img-circle' src='getimagem/".$_SESSION['id']."/' >"; 
                                    ?>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-body">
                                        <?php
                                            echo "<img height='160' width='160' src='getimagem/".$_SESSION['id']."/' class='img-circle img-responsive center-block'>"; 
                                        ?>
