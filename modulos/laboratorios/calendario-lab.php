...
<?php
  ...
  $aux->execute();
  $aux->bind_result($inicio, $fim, $nomeUser, $cor, $motivoReLab, $nomeLab, $tituloReLab);
  $aux->store_result();
?>
              ...
              <div class="box box-solid" id="box">
                ...
                <div class="box-body">
                  <form role="form" action="post/" method="post" name="formulario" id="formulario" class="formulario">
                    ...
                    ?>
                    <div class="form-group">
                      <label>Relacionar a um professor</label>
              ...
              <div class="box-body">
                <?php
                  ...
                  if ($query = $db->prepare("SELECT a.nomeLab, b.cor, a.capAluno, a.numComp FROM tbLaboratorio a
                    ...
                    while ($query->fetch()) {
                      echo '<span class="label" data-toggle="tooltip" title="Capacidade de Alunos: '.$capAluno.' & Número de máquinas: '.$numComp.'" style="background-color: '.$cor.';">'
                      .$nomeLab.'</span><br>';
                    }
                    $query->close();
                  }
      ...
      $('#calendar').fullCalendar({
        ...
        events: [
          <?php
              ...
              /*
                Inicio da exibição das reservas que ainda estão pendentes.
                Somente para nível de secretaria.
              */
              if($_SESSION['logado'] && $_SESSION['nivel'] == 1){
                ...
                while ($aux->fetch()){
                  ...
                  echo "{
                          ...
                          url: '[PENDENTE - ID: ".$idReLab."] ".$tituloReLab." - ".date('H:i', $comeco)." às ".
                          date('H:i', $final)." para ".$nomeUser."',
                          borderColor: '#22313F'
                        }";
                }
              ...
              /*
                Fim da exibição das reservas que ainda estão pendentes.
              */
